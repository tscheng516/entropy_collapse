...
Override frequencies (default 10)::

    python plot_history.py out/shakespeare/.../history.pkl \\
        --hessian_freq 10 --entropy_freq 10
...
def main():
    ...
    parser.add_argument(
        "--hessian_freq", type=int, default=10,
        help="Hessian computation frequency used during training (default: 10)",
    )
    parser.add_argument(
        "--entropy_freq", type=int, default=10,
        help="Entropy computation frequency used during training (default: 10)",
    )
    parser.add_argument(
